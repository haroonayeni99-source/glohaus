...
| ------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| 1. Account foundation                       | Clerk integration, server-owned customer/professional/admin roles, RLS, admin MFA, setup documentation                                                    | Provision Clerk/PostgreSQL, test distinct real identities, deployment and recovery checks                                           |
