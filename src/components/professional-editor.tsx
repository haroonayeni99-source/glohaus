...
export function ProfessionalEditor({
  ...
  return (
    <>
      ...
      {section !== "services" && initial && (
        <>
          <div className="profile-edit-toolbar">
            ...
            >
              {showPreview ? "Close preview" : "Preview changes"}
            </button>
          </div>
          {showPreview && preview && (
            <section
              className="profile-draft-preview"
              aria-label="Unsaved profile preview"
            >
              <p className="eyebrow">PREVIEW · SAVE TO APPLY YOUR CHANGES</p>
              <span className="customer-avatar" aria-hidden>
                {preview.businessName?.slice(0, 1) || "G"}
              </span>
              <h2>{preview.businessName || "Your business name"}</h2>
              <p>@{preview.slug || "your-profile"}</p>
              <p>{preview.city || "Your city"}</p>
              <p className="preview-bio">
                {preview.bio || "Your bio appears here."}
              </p>
              <p>{preview.businessDescription}</p>
              <span className="pill">
          ...
          <form
            onChange={(event) => {
              ...
              setPreview({ ...initial, ...values } as ProfileInput);
            }}
          ...
          >
            ...
            <div className="field-grid">
              ...
              <label>
                ...
                />
                <small>
                  GLOHAUS / p / your-name · lowercase letters, numbers and
                  hyphens
                </small>
              </label>
              <label>
            ...
            <label>
              ...
              />
              <small>
                Tell clients about your experience, approach and the atmosphere
                of your business.
              </small>
            </label>
            <label>
              ...
              />
              <small>
                Optional neighbourhood or public studio address. Do not include
      ...
      {section !== "profile" && (
        <>
          <nav className="management-tabs" aria-label="Service status">
          ...
          <section className="service-edit-list" aria-label="Your services">
            {services
              ...
              .map((service) => (
                <article key={service.id} className="service-edit-row">
                  {service.asset_id && (
                    <Image
                      className="service-editor-image"
                  ...
                  <div>
                    ...
                    {service.deposit_pence >
                      ...
                      <p className="deposit-limit-error">
                        This service needs a deposit update before it can be
                        booked.
                      </p>
                    )}
                  </div>
            ...
            {!services.some(
              ...
              <p className="service-empty">
                No {filter === "all" ? "" : filter} services yet. Add your
                service below.
              </p>
            )}
          </section>
          ...
          >
            ...
            <p>
              Choose a portfolio image. Publish it in your portfolio to show it
              on your public service menu.{" "}
